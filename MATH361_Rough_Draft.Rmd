...
df$fall_winter_dummy <- ifelse(df$season %in% c(2, 3), 1, 0)
...
veryfinalmodel = lm(total_trips ~ Mean_Humidity+MeanDew_Point_F+Precipitation_In+Mean_Wind_Speed_MPH+fall_winter_dummy+weekday_weekend, data = df)
